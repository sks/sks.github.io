...
| [Running AppWorld Locally for Aiden Agent Evals](/blog/running-appworld-locally-genie-agent-eval/) | Docker Compose, official MCP HTTP, health gates, and setup pitfalls (pt. 5 — ops prerequisite) |
