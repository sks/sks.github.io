...
This is a Jekyll-based personal blog hosted on GitHub Pages at `sks.github.io`. It contains a 12-part blog series: **"Building an Enterprise AI Agent Platform in Go"** by Sabith K Soopy.
...
3. **Never disclose O-1 visa intent** — no references to immigration, visa applications, or personal legal matters in any public content.
